...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f4f3ee] p-5 lg:p-8">
      <div className="max-w-md w-full bg-white shadow-2xl rounded-xl p-6 sm:p-8 space-y-6 transform transition-all duration-500 ease-in-out hover:scale-105">
        <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-800 text-center mb-5">
          Register for Trimly
        </h1>
